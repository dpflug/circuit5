...
* When you receive your receipt for any purchases you've made
  ...
  3) If the transaction isn't there:
     ...
     10) Make sure the ORG and OBJECT codes are right. These should be in the original purchase ticket, or you can get them from the budget spreadsheets. It's not always clear where the delineations are between these, so try to get someone else to pick them for you.
...
* When you receive the email from Works saying your statement's ready
  If the above steps have been completed for all transactions:
    ...
    2) Email the signed statement to Susan Berg and Linda Lorentz. The Machine provides no means; you are on your own, pilgrim.
